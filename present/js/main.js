			...
			function mostrar(){
				...
				.then(data => {
					...
					<a href="single.html">
						...
						<h2>${valor.title.$t}</h2>
						<p>${valor.id.$t}</p><br>
						<button type="button" class="btn btn-light btn-lg btn-block"><a href="https://api.whatsapp.com/send?phone=5491164179643&text=Hola%me%contacto%por%las%remeras">Contactar</button>
